  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li>
          <a href="forms-validationb.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Forms Add Brand</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
          <div class="card col-lg">
            <div class="card-body">
              <h5 class="card-title">Forms Add Data Brand</h5>
              
              <!-- Custom Styled Validation with Tooltips -->
              <form class="row g-3 needs-validation" method="post" action="prosesaddb.php" novalidate>
                <div class="row position-relative mb-3">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="id_brand">Id Brand &emsp;&emsp;&emsp;</span>
                    <input type="number" class="form-control" name="id_brand" id="id_brand" aria-describedby="id_brand" disabled>
                    <div class="invalid-tooltip">
                      Please choose a unique and valid Id Brand.
                    </div>
                  </div>
                </div>
                <div class="row position-relative">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input type="text" class="form-control" name="name_brand" id="name_brand" aria-describedby="name_brand" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                    <div class="invalid-tooltip">
                      Please choose a unique and valid Name Brand.
                    </div>
                  </div>
                </div>
                <div class="row mt-4">
