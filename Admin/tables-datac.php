  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li>
          <a href="tables-datac.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tables Data Category</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Datatables Category</h5>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td> <a href="updatec.php?id_category=<?php echo $d['id_category'];?>" class="btn btn-warning">Update</a></td>
                      <td> <a href="deletec.php?id_category=<?php echo $d['id_category'];?>" class="btn btn-danger">Delete</a></td>
                    </tr>
