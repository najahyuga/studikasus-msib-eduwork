  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="update-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li>
          <a href="updatedatac.php" class="active">
      ...
      <div class="row">
          <div class="card col-lg">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" method="post" action="prosesupdatec.php?id_category=<?php echo $id_category ?>" novalidate>
                <div class="row position-relative mb-3">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="id_category">Id Category &emsp;&emsp;&emsp;</span>
                    <input type="number" name="id_category" class="form-control" id="id_category" value="<?php echo $id_category ?>" aria-describedby="id_category" disabled>
                    <div class="invalid-tooltip">
                      Please Provide a valid id_category.
                    </div>
                  </div>
                </div>
                <div class="row position-relative">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="name_category">Name Category &emsp;</span>
                    <input type="text" name="name_category" class="form-control" id="name_category" value="<?php echo $name_category ?>" aria-describedby="name_category" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                    <div class="invalid-tooltip">
                      Please Provide a valid name_category.
                    </div>
                  </div>
                </div>
                <div class="row mt-4">
