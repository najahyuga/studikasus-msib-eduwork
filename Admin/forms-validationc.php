    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Forms Add Category</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
          <div class="card col-lg">
            <div class="card-body">
              <h5 class="card-title">Forms Add Data Category</h5>
              
              <!-- Custom Styled Validation with Tooltips -->
              <form class="row g-3 needs-validation" method="post" action="prosesaddc.php" novalidate>
                <div class="row position-relative mb-3">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="id_category">Id Category &emsp;&emsp;&emsp;</span>
                    <input type="number" name="id_category" class="form-control" id="id_category" aria-describedby="id_category" disabled>
                ...
                <div class="row position-relative">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input type="text" name="name_category" class="form-control" id="name_category" aria-describedby="name_category" required>
