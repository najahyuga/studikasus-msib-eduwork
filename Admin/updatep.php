...
<body>
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <!-- Start Update Nav -->
    <li class="nav-item">
      <a class="nav-link collapse" data-bs-target="#update-nav" data-bs-toggle="collapse" href="#">
      ...
      <ul id="update-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="updatedatap.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="updatedatac.php">Update Data Category</a></li>
          <li class="breadcrumb-item active">Form Update Data Category</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
          <div class="card col-lg">
            <div class="card-body">
              <h5 class="card-title">Forms Update Data Category</h5>
              <?php
              ...
              <form class="row g-3 needs-validation" method="post" action="prosesupdatep.php?id_product=<?php echo $id_product ?>" enctype="multipart/form-data" novalidate>
              <div class="row position-relative mb-3">
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="id_product">Id Product &emsp;&emsp;&emsp;</span>
                    <input type="number" name="id_product" class="form-control" value="<?php echo $row['id_product']; ?>" id="id_product" aria-describedby="id_product" disabled>
                ...
                <div class="row position-relative mb-3">
                  <div class="input-group has-validation">
                    ...
                    <input type="text" name="name_product" class="form-control" id="name_product" value="<?php echo $row['name_product']; ?>" aria-describedby="name_product" required>
                ...
                <div class="row position-relative mb-3">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input type="number" name="price_product" class="form-control" id="price_product" value="<?php echo $row['price_product']; ?>" aria-describedby="price_product" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                    <div class="invalid-tooltip">
                ...
                <div class="row position-relative mb-3">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input type="number" name="qty_product" class="form-control" id="qty_product" value="<?php echo $row['qty_product']; ?>" aria-describedby="qty_product" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                    <div class="invalid-tooltip">
                ...
                <div class="row position-relative mb-3">
                  <div class="input-group has-validation">
                    ...
                    <input type="file" name="image" value="<?php echo $row['image']; ?>" class="form-control" id="image" aria-describedby="image" >
                    <div class="valid-tooltip">
                      Looks good!
                    </div> 
                    <div class="invalid-tooltip">
