                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td> <a href="updatep.php?id_product=<?php echo $d['id_product'];?>" class="btn btn-warning">Update</a></td>
                      <td> <a href="deletep.php?id_product=<?php echo $d['id_product'];?>" class="btn btn-danger">Delete</a></td>
                    </tr>
                  <?php $no++; } } ?>
                </tbody>
