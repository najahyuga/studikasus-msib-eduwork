  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="update-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="updatedatab.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="updatedatab.php">Update Data Brand</a></li>
          <li class="breadcrumb-item active">Form Update Data Brand</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
          <div class="card col-lg">
            <div class="card-body">
                <h5 class="card-title">Forms Update Data Brand</h5>
                <?php
              ...
              <form class="row g-3 needs-validation" method="post" action="prosesupdateb.php?id_brand=<?php echo $id_brand ?>" novalidate>
                <div class="row position-relative mb-3">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="id_brand">Id Category &emsp;&emsp;&emsp;</span>
                    <input type="number" name="id_brand" class="form-control" id="id_brand" value="<?php echo $id_brand ?>" aria-describedby="id_brand" disabled>
                ...
                <div class="row position-relative">
                  <!-- <label for="validationTooltipUsername" class="form-label">Username</label> -->
                  <div class="input-group has-validation">
                    <span class="input-group-text" id="name_brand">Name Brand &emsp;</span>
                    <input type="text" name="name_brand" class="form-control" id="name_brand" value="<?php echo $name_brand ?>" aria-describedby="name_brand" required>
