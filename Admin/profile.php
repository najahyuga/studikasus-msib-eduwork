...
<aside id="sidebar" class="sidebar">
    ...
    <!-- End Update Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapse" href="profile.php">
          <i class="bi bi-person"></i>
        ...
        <div class="col-xl-5">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <img src="image/fotoku.jpg" alt="Profile" class="rounded-circle">
              <h2>Muhammad Najah Yuga D</h2>
              <h3>RPL</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">Nama saya Muhammad Najah Yuga Desyalwa.
                  Saya mahasiswa Institut Teknologi Telkom Surabaya,
                  mengambil jurusan Rekayasa Perangkat Lunak.
                  Selama kuliah saya aktif dalam mengikuti kepanitian dan
                  menjadi asisten praktikum. Saya orang yang suka
                  belajar hal baru serta suka bekerja di dalam tim
                  dan menyukai hal yang menambah
                  pengalaman.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Muhammad Najah Yuga Desyalwa</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Surabaya</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">+62</div>
                  </div>
